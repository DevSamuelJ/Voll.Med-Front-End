# 🤝 Guia de Contribuição – Voll.Med

Obrigado por se interessar em contribuir com o VollMed!
...
O VollMed é uma plataforma open source de estudos com flashcards, onde as coleções podem ser criadas com auxílio de AI e compartilhadas pela comunidade.
...
```bash
git clone https://github.com/davi-lucciola/VollMed.git
cd VollMed
```
